...
import 'package:marketmate_app/views/presentation/detail/screens/shipping_address_screen.dart';
...
class _CheckoutScreenState extends ConsumerState<CheckoutScreen> {
  ...
  Future<void> handleStripePayment(BuildContext context) async {
    ...
    try {
      ...
      //Calculate total amount for all item in cart
      ...
      print("Payment: ${paymentIntentStatus['status']}");
      ...
      if (paymentIntentStatus['status'] == 'succeeded') {
        ...
        for (final entry in cartData.entries) {
          ...
          await orderController.upfloadOrders(
              id: '',
        ...
        showSnackBar(
            context, 'Payment Status : ${paymentIntentStatus['status']}');
      }
    } catch (e) {
      print('PaymentFailed data: $e');
      showSnackBar(context, 'Payment Failed data : $e');
    } finally {
      setState(() {
        isLoading = false;
      });
