...
import 'package:marketmate_app/provider/order_provider.dart';
import 'package:marketmate_app/provider/user_provider.dart';
import 'package:marketmate_app/views/presentation/detail/screens/order_detail_screen.dart';
...
class _OrderScreenState extends ConsumerState<OrderScreen> {
    ...
    if (user != null) {
      ...
      try {
        final orders = await orderController.loadOrders(
            buyerId: user.id, context: context);
  ...
  Future<void> _deleteOrders(String orderId) async {
    final OrderController orderController = OrderController();
    try {
