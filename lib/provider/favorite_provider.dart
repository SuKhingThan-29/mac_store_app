...
class FavoriteNotifier extends StateNotifier<Map<String, Favorite>> {
  ...
  //A private method that loads items from sharepreferences
  Future<void> _loadFavorites() async {
    //retrieving the sharepreferences instance to store data
    final prefs = await SharedPreferences.getInstance();
    //fetch the json String of the favorite items from sharepreference under the key favorites
    ...
    if (favoriteString != null) {
      ...
      //convert dynamic map into a map of Favorite object using the 'fromjson' factory method
  ...
  Future<void> _saveFavorites() async {
    ...
    //saving the json string to sharepreference with the key "favorites"
    await pref.setString('favorites', favoriteString);
  }
